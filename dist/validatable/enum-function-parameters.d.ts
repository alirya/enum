...
export declare type Type<Message, Enumerate extends Record<string, any>, Argument extends unknown> = ValidatorReturn<unknown, Argument, Object.UnionOf<Enumerate>, EnumClassParameters<Message, Enumerate, Argument>> & {
    enumerate: Enumerate;
};
