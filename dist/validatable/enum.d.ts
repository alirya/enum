...
declare type Return<Message, Enumerate extends object, Argument extends unknown> = ValidatorReturn<unknown, Argument, Object.UnionOf<Enumerate>, EnumValidatable<Message, Enumerate, Argument>> & {
    enumerate: Enumerate;
};
